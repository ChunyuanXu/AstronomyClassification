# -*- coding: utf-8 -*-
"""
Created on Fri Mar 02 16:02:01 2018
...
#unknown_data = xgb.DMatrix(data_unknown[:, :-1])
#param = {'objective':'multi:softprob', 'max_depth':9, 'eta':0.3, 'silent':1,  \
#        'num_class':3, 'seed':1, 'min_child_weight':6, 'gamma':0.25, 'scale_pos_weight':1}
#num_round = 100
#bst = xgb.train(param, train_data, num_round)
#bst_rst = bst.predict(unknown_data)
...
#unknown_idx = pred < 0.9
#idx[unknown_idx] = 3
#
#np.save('midResult/bst_rst_unknown_add.npy', idx)